package com.example.bearhunting.voicedemo.Activity;
...
import com.example.bearhunting.voicedemo.MyAdapter;
...
public class GroupManagerActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    private void initLayout() {
        ...
        relativeLayout = view.findViewById(R.id.group_manager_layout);

        mUserNameText = view.findViewById(R.id.txt_username);
...
//        }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (mfv_type.equals("ivp")) {
            init.setClass(this,VocalIdentifyActivity.class);
        }else {
